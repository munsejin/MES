...
{
    public partial class frm반제품이력관리 : Form
    {
        wnDm wnDm = new wnDm();
        ...
        private void frm반제품이력관리_Load(object sender, EventArgs e)
        {
        ...
        private void btnSrch_Click(object sender, EventArgs e)
        {
            ...
            {
                item_nm += "AND ZZ.HALF_ITEM_CD = '" + txt_srch.Tag + "' ";
            }
        ...
        private void item_grid_list(string condition)
        {
            ...
            dt = wDm.화인반제품이력관리_list(condition);
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    {
                        itemGrid.Rows[i].Cells["RAW_CD"].Value = dt.Rows[i]["HALF_ITEM_CD"].ToString();
                        itemGrid.Rows[i].Cells["RAW_NM"].Value = dt.Rows[i]["ITEM_NM"].ToString();
