...
{
    public partial class frm화학적_위해요소 : Form
    {
        wnDm wnDm = new wnDm();
        ...
        private void frm화학적_위해요소_Load(object sender, EventArgs e)
        {
        ...
        private void insert_file()
        {
            ...
            string targetPath = @txt_root_path.Text + "/화학적위해요소/";
            ...
            if (System.IO.Directory.Exists(targetPath))
            {
                ...
                else
                {
                    ...
                    {
                        wnDm wDm = new wnDm();
                        int rst = wDm.insert_Haccp_Doc_File(targetPath + "/" + fileName, fileName, txt_staff_cd.Text, input_date.Text, txt_comment.Text, "2");
                        if (rst == 0)
                        {
                            try
                            {
        ...
        private void HaccpGrid3_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void HaccpGrid3_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
