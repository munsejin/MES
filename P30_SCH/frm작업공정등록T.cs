...
namespace MES.P30_SCH
{
    ...
    /// 
    /// </summary>
    public partial class frm작업공정등록T : Form
    {
        ...
        private Popup.pop원자재반환 pop = new Popup.pop원자재반환();
        ...
        public frm작업공정등록T(IfrmInterface pFrm)
        {
            InitializeComponent();
        ...
        private void frm작업공정등록T_Load(object sender, EventArgs e)
        {
