...
{
    public partial class frm일일매출원장 : Form
    {
        ...
        private void frm일일매출원장_Load(object sender, EventArgs e)
        {
        ...
        private void in_grid_logic()
        {
            ...
            sb.AppendLine("and Z.SALES_DATE >= '" + start_date.Text.ToString() + "' and  Z.SALES_DATE <= '" + end_date.Text.ToString() + "'   ");

            dt = wDm.fn_Sales_Day_Ledger_List(sb.ToString(), start_date.Text.ToString(), end_date.Text.ToString());
        ...
        private void btn출력_Click(object sender, EventArgs e)
        {
            ...
            {
                sfd.FileName = start_date.Text + " 매출일지";
            }
            else
            {
                sfd.FileName = start_date.Text + " ~ " + end_date.Text + " 매출일지";
            }
