...
{
    public partial class frm수입검사기준등록 : Form
    {
        ...
        private void frm수입검사기준등록_Load(object sender, EventArgs e)
        {
        ...
        private void dataChkGrid_VisibleChanged(object sender, EventArgs e)
        {
