...
{
    public partial class frm품질분석현황 : Form
    {
        ...
        private void ResetChart()
        {
            ...
            //chart_flow.ChartAreas[0].AxisY.MajorGrid.IntervalType = chart_flow.ChartAreas[0].AxisY2.MajorGrid.IntervalType;
            //chart_flow.ChartAreas[0].AxisY.MajorGrid.IntervalOffset = chart_flow.ChartAreas[0].AxisY2.MajorGrid.IntervalOffset;
            //chart_flow.ChartAreas[0].AxisY.MajorGrid.Enabled = chart_flow.ChartAreas[0].AxisY2.MajorGrid.Enabled;
            ...
            chart_raw.ChartAreas[0].AxisY.MajorGrid.LineColor = ColorBlue;
            chart_raw.ChartAreas[0].AxisY.MajorGrid.LineWidth = 2;
            chart_raw.ChartAreas[0].AxisY2.MajorGrid.Enabled = false;
            chart_raw.ChartAreas[0].AxisY2.IntervalAutoMode = System.Windows.Forms.DataVisualization.Charting.IntervalAutoMode.FixedCount;
            chart_raw.ChartAreas[0].AxisY2.MajorGrid.LineColor = ColorOrange;
            chart_raw.ChartAreas[0].AxisY2.MajorGrid.LineWidth = 2;

            chart_flow.ChartAreas[0].AxisY.MajorGrid.LineColor = ColorBlue;
            chart_flow.ChartAreas[0].AxisY.MajorGrid.LineWidth = 2;
            chart_flow.ChartAreas[0].AxisY2.MajorGrid.Enabled = false;
            chart_flow.ChartAreas[0].AxisY2.IntervalAutoMode = System.Windows.Forms.DataVisualization.Charting.IntervalAutoMode.FixedCount;
            chart_flow.ChartAreas[0].AxisY2.MajorGrid.LineColor = ColorOrange;
            chart_flow.ChartAreas[0].AxisY2.MajorGrid.LineWidth = 2;

            chart_item.ChartAreas[0].AxisY.MajorGrid.LineColor = ColorBlue;
            chart_item.ChartAreas[0].AxisY.MajorGrid.LineWidth = 2;
            chart_item.ChartAreas[0].AxisY2.MajorGrid.Enabled = false;
            chart_item.ChartAreas[0].AxisY2.IntervalAutoMode = System.Windows.Forms.DataVisualization.Charting.IntervalAutoMode.FixedCount;
            chart_item.ChartAreas[0].AxisY2.MajorGrid.LineColor = ColorOrange;
            chart_item.ChartAreas[0].AxisY2.MajorGrid.LineWidth = 2;

            chart_raw_date.ChartAreas[0].AxisY.MajorGrid.LineColor = ColorBlue;
            chart_raw_date.ChartAreas[0].AxisY.MajorGrid.LineWidth = 2;
            chart_raw_date.ChartAreas[0].AxisY2.MajorGrid.Enabled = false;
            chart_raw_date.ChartAreas[0].AxisY2.IntervalAutoMode = System.Windows.Forms.DataVisualization.Charting.IntervalAutoMode.FixedCount;
            chart_raw_date.ChartAreas[0].AxisY2.MajorGrid.LineColor = ColorOrange;
            chart_raw_date.ChartAreas[0].AxisY2.MajorGrid.LineWidth = 2;

            chart_flow_date.ChartAreas[0].AxisY.MajorGrid.LineColor = ColorBlue;
            chart_flow_date.ChartAreas[0].AxisY.MajorGrid.LineWidth = 2;
            chart_flow_date.ChartAreas[0].AxisY2.MajorGrid.Enabled = false;
            chart_flow_date.ChartAreas[0].AxisY2.IntervalAutoMode = System.Windows.Forms.DataVisualization.Charting.IntervalAutoMode.FixedCount;
            chart_flow_date.ChartAreas[0].AxisY2.MajorGrid.LineColor = ColorOrange;
            chart_flow_date.ChartAreas[0].AxisY2.MajorGrid.LineWidth = 2;

            chart_item_date.ChartAreas[0].AxisY.MajorGrid.LineColor = ColorBlue;
            chart_item_date.ChartAreas[0].AxisY.MajorGrid.LineWidth = 2;
            chart_item_date.ChartAreas[0].AxisY2.MajorGrid.Enabled = false;
            chart_item_date.ChartAreas[0].AxisY2.IntervalAutoMode = System.Windows.Forms.DataVisualization.Charting.IntervalAutoMode.FixedCount;
            chart_item_date.ChartAreas[0].AxisY2.MajorGrid.LineColor = ColorOrange;
            chart_item_date.ChartAreas[0].AxisY2.MajorGrid.LineWidth = 2;
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            sfd.FileName = "("+lbl_start_date.Text+" ~ "+lbl_end_date.Text + ") 품질분석현황";

            if (sfd.ShowDialog() == DialogResult.OK)
            {
                lblMsg.Visible = true;
                Application.DoEvents();
                wnGConstant.dataGridView_ExportToExcel_Poor_Anal(
                    sfd.FileName
                    , lbl_start_date.Text
                    , lbl_end_date.Text
                    , chart_raw
