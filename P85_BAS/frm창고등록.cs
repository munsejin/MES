    ...
    public partial class frm창고등록 : Form
    {
        ...
        private void bindData(string condition)
        {
            ...
            try
            {
                wnDm wDm = new wnDm();
                DataTable dt = null;
                dt = wDm.fn_STORECODE_List(condition);
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    {
                        this.GridRecord.Rows[i].Cells[0].Value = dt.Rows[i]["STORE_CODE"].ToString();
        ...
        private void getDetailPost(string sKey)
        {
            ...
            try
            {
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    this.txtCode.Text = dt.Rows[0]["STORE_CODE"].ToString();
        ...
        private bool insertPost()
        {
            ...
            try
            {
                ...
                sb.AppendLine(" insert into STORECODE ( ");
...
wnLog.writeLog(wnLog.LOG_ERROR, ex.Message + " - " + ex.ToString());Popup.pop오류리포트 msg = new Popup.pop오류리포트(ex.Message + " - " + ex.ToString());
        ...
        private bool updatePost()
        {
            ...
            try
            {
                ...
                sb.AppendLine(" update STORECODE set ");
                sb.AppendLine("     CODE_DESC = @CODE_DESC ");
                sb.AppendLine(" where 1=1 ");
                sb.AppendLine("     and STORE_CODE = @p1 ");
...
wnLog.writeLog(wnLog.LOG_ERROR, ex.Message + " - " + ex.ToString());Popup.pop오류리포트 msg = new Popup.pop오류리포트(ex.Message + " - " + ex.ToString());
        ...
        private bool deletePost()
        {
            ...
            try
            {
                ...
                sb.AppendLine(" delete from STORECODE ");
                sb.AppendLine(" where STORE_CODE = @p1  ");
