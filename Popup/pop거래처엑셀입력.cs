...
namespace MES.Popup
{
    public partial class pop거래처엑셀입력 : Form
    {
        ...
        private void pop거래처엑셀입력_Load(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK)
            {
                ...
                try
                {
                    ...
                    for (int i = 0; i < excelGrid.Rows.Count; i++)
                    {
                        ...
                        if (excelGrid.Rows[i].Cells[13].Value == null || excelGrid.Rows[i].Cells[13].Value.ToString().Equals(""))
                        {
                            excelGrid.Rows[i].Cells[13].Value = DateTime.Now.ToString("yyyy-MM-dd");
                        }

                        if (excelGrid.Rows[i].Cells[14].Value == null || excelGrid.Rows[i].Cells[14].Value.ToString().Equals(""))
                        {
                            excelGrid.Rows[i].Cells[14].Value = Common.p_strStaffNo;
                        }

                        if (excelGrid.Rows[i].Cells[17].Value == null || excelGrid.Rows[i].Cells[17].Value.ToString().Equals(""))
                        {
                            excelGrid.Rows[i].Cells[17].Value = "100";
                        }

                        if (excelGrid.Rows[i].Cells[0].Value == null || excelGrid.Rows[i].Cells[0].Value.ToString().Equals("")
                            || excelGrid.Rows[i].Cells[1].Value == null || excelGrid.Rows[i].Cells[1].Value.ToString().Equals("")
                            || excelGrid.Rows[i].Cells[2].Value == null || excelGrid.Rows[i].Cells[2].Value.ToString().Equals("")
                            || excelGrid.Rows[i].Cells[16].Value == null || excelGrid.Rows[i].Cells[16].Value.ToString().Equals(""))
                        {
        ...
        private void CopyExcel_Templete(string targetPath)
        {
            try
            {
                string fileName = "MES_거래처입력양식.xlsx";
